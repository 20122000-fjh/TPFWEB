...
public class Pedido implements Serializable{
    ...
    public Pedido(long codigo, String destino, String estado, Date fechaEntrega, Date fechaCreacion, long numero_tarjeta, long transportista, int id_centrodistribucion, long dni_cliente/*, List<Producto> productos, List<Cliente> clientes*/) {
        this.codigo = codigo;
